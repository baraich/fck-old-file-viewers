...
const PDFRenderer = ({ fileUrl, config }) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { style: {
            ...
            }, file: "https://cdn.api.baraich.cloud/1726908845Title_The Essential Role of Security Cameras in Enhancing Public Safety.pdf", children: config.props.showAll ? (Array.from({ length: numPages }, (_, index) => ((0, jsx_runtime_1.jsx)(react_pdf_1.Page, { pageIndex: index }, index)))) : ((0, jsx_runtime_1.jsx)(react_pdf_1.Page, { pageIndex: 0 })) }) }));
};
